...
namespace NClap.Repl
{
    ...
    public static class Loop
    {
        ...
        /// Executes the loop.
        /// </summary>
        public static void Execute(IEnumerable<VerbDescriptor> verbs) => Execute(verbs, (LoopInputOutputParameters)null, null);

        /// <summary>
        /// Executes the loop.
        /// </summary>
        /// <param name="loopClient">Options for loop.</param>
        public static void Execute(IEnumerable<VerbDescriptor> verbs, ILoopClient loopClient) => Execute(verbs, loopClient, null);

        /// <summary>
        /// Executes the loop.
        /// </summary>
        /// <param name="options">Options for loop.</param>
        public static void Execute(IEnumerable<VerbDescriptor> verbs, LoopOptions options) => Execute(verbs, (LoopInputOutputParameters)null, options);
        ...
        /// <param name="options">Options for loop.</param>
        public static void Execute(IEnumerable<VerbDescriptor> verbs, LoopInputOutputParameters parameters, LoopOptions options) => Execute<object>(verbs, parameters, options, null);
